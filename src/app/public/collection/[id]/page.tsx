              ...
              {COLOR_OPTIONS.map((c) => (
                <UnstyledButton
                  ...
                  style={{
                    ...
                    border: colors.includes(c) ? '2px solid var(--mantine-color-violet-6)' : '2px solid var(--mantine-color-gray-4)',
                    background: colors.includes(c) ? 'var(--mantine-color-violet-0)' : 'transparent',
